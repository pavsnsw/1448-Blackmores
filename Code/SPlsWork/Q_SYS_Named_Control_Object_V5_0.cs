...
namespace UserModule_Q_SYS_NAMED_CONTROL_OBJECT_V5_0
{
    public class UserModuleClass_Q_SYS_NAMED_CONTROL_OBJECT_V5_0 : SplusObject
    {
...
public UserModuleClass_Q_SYS_NAMED_CONTROL_OBJECT_V5_0 ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
